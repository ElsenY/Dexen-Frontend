    ...
    <div className="min-h-screen bg-[#0f172a] flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10 glass rounded-3xl p-8 md:p-12 animate-fade-up">
        <div className="flex flex-col items-center mb-10">
          ...
          <p className="text-slate-400 text-center">Enter your details to access your account</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          <div className="space-y-2">
            ...
            <div className="relative group">
              <Mail className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-500 group-focus-within:text-[#6366f1] transition-colors" size={20} />
              <input
                type="email"
          ...
          <div className="space-y-2">
            ...
            <div className="relative group">
              <Lock className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-500 group-focus-within:text-[#6366f1] transition-colors" size={20} />
              <input
                type="password"
                placeholder="••••••••"
                required
